...

{
  ...
  function getPropNames(obj) {
    Object.defineProperty(obj, "skip_this_prop", {
      enumerable: false,
    });
    return Object.keys(obj);
  }
...

{
  ...
  function unionObjects(objPart1, objPart2) {
    return Object.assign(Object.assign({}, objPart1), objPart2);
  }
...

{
  ...
  function copyObject1(inputObj) {
    const clone = Object.create(Object.getPrototypeOf(inputObj));

    const props = Object.getOwnPropertyNames(inputObj);
    props.forEach(function (key) {
      const desc = Object.getOwnPropertyDescriptor(inputObj, key);
